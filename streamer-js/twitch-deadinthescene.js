export class TwitchStreamdeadinthescene extends HTMLElement {
    ...
    importTwitch() {
        return new Promise((resolve, reject) => {
            ...
            script.src = TwitchStreamdeadinthescene.TWITCH_EMBED_URL;
    ...
    render() {
        const content = TwitchStreamdeadinthescene.template.content.cloneNode(true);
    ...
    setDefaults() {
        const attributes = TwitchStreamdeadinthescene.attributes;
