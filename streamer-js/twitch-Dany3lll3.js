export class TwitchStreamdany3lll3 extends HTMLElement {
  ...
  importTwitch() {
    return new Promise((resolve, reject) => {
      ...
      script.src = TwitchStreamdany3lll3.TWITCH_EMBED_URL;
  ...
  render() {
    const content = TwitchStreamdany3lll3.template.content.cloneNode(true);
  ...
  setDefaults() {
    const attributes = TwitchStreamdany3lll3.attributes;
